...
// Common Helpers
@module external closestIndexTo: (Js.Date.t, array<Js.Date.t>) => int = "date-fns/closestIndexTo"
@module external closestTo: (Js.Date.t, array<Js.Date.t>) => Js.Date.t = "date-fns/closestTo"
...
@module
external formatOpt: (Js.Date.t, string, formatOptions) => string = "date-fns/format"
@module
...
@module external eachWeekOfInterval: interval => array<Js.Date.t> = "date-fns/eachWeekOfInterval"
...
external getOverlappingDaysInIntervalsf: (interval, interval) => float =
  "date-fns/getOverlappingDaysInIntervals"
@module external isWithinInterval: (Js.Date.t, interval) => bool = "date-fns/isWithinInterval"
...
// Millisecond Helpers
@module external addMilliseconds: (Js.Date.t, int) => Js.Date.t = "date-fns/addMilliseconds"
@module external addMillisecondsf: (Js.Date.t, float) => Js.Date.t = "date-fns/addMilliseconds"
@module
...
@module external setMilliseconds: (Js.Date.t, int) => Js.Date.t = "date-fns/setMilliseconds"
@module external setMillisecondsf: (Js.Date.t, float) => Js.Date.t = "date-fns/setMilliseconds"
@module external subMilliseconds: (Js.Date.t, int) => Js.Date.t = "date-fns/subMilliseconds"
@module external subMillisecondsf: (Js.Date.t, float) => Js.Date.t = "date-fns/subMilliseconds"
...
@module external differenceInSeconds: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInSeconds"
@module
...
@module external differenceInMinutes: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInMinutes"
@module
...
@module external roundToNearestMinutes: Js.Date.t => Js.Date.t = "date-fns/roundToNearestMinutes"
...
@module external differenceInHours: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInHours"
@module external differenceInHoursf: (Js.Date.t, Js.Date.t) => float = "date-fns/differenceInHours"
...
// Day Helpers
@module external addBusinessDays: (Js.Date.t, int) => Js.Date.t = "date-fns/addBusinessDays"
@module external addBusinessDaysf: (Js.Date.t, float) => Js.Date.t = "date-fns/addBusinessDays"
...
@module external differenceInDaysf: (Js.Date.t, Js.Date.t) => float = "date-fns/differenceInDays"
...
@module external subBusinessDays: (Js.Date.t, int) => Js.Date.t = "date-fns/subBusinessDays"
@module external subBusinessDaysf: (Js.Date.t, float) => Js.Date.t = "date-fns/subBusinessDays"
...
@module external setDayOpt: (Js.Date.t, int, setDayOptions) => Js.Date.t = "date-fns/setDay"
@module external setDayOptf: (Js.Date.t, float, setDayOptions) => Js.Date.t = "date-fns/setDay"
...
external differenceInCalendarWeeksOptf: (Js.Date.t, Js.Date.t, weekOptions) => float =
  "date-fns/differenceInCalendarWeeks"
@module external differenceInWeeks: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInWeeks"
@module external differenceInWeeksf: (Js.Date.t, Js.Date.t) => float = "date-fns/differenceInWeeks"
@module external endOfWeek: Js.Date.t => Js.Date.t = "date-fns/endOfWeek"
@module external endOfWeekOpt: (Js.Date.t, weekOptions) => Js.Date.t = "date-fns/endOfWeek"
...
@module external getWeekOfMonthOptf: (Js.Date.t, weekOptions) => float = "date-fns/getWeekOfMonth"
...
@module external getWeeksInMonthOptf: (Js.Date.t, weekOptions) => float = "date-fns/getWeeksInMonth"
@module external isSameWeek: (Js.Date.t, Js.Date.t) => bool = "date-fns/isSameWeek"
@module external isSameWeekOpt: (Js.Date.t, Js.Date.t, weekOptions) => bool = "date-fns/isSameWeek"
...
@module external setWeekOpt: (Js.Date.t, int, setWeekOptions) => Js.Date.t = "date-fns/setWeek"
@module external setWeekOptf: (Js.Date.t, float, setWeekOptions) => Js.Date.t = "date-fns/setWeek"
@module external startOfWeek: Js.Date.t => Js.Date.t = "date-fns/startOfWeek"
@module external startOfWeekOpt: (Js.Date.t, weekOptions) => Js.Date.t = "date-fns/startOfWeek"
...
external differenceInCalendarMonthsf: (Js.Date.t, Js.Date.t) => float =
  "date-fns/differenceInCalendarMonths"
@module external differenceInMonths: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInMonths"
@module
external differenceInMonthsf: (Js.Date.t, Js.Date.t) => float = "date-fns/differenceInMonths"
@module external eachWeekendOfMonth: Js.Date.t => array<Js.Date.t> = "date-fns/eachWeekendOfMonth"
...
external differenceInCalendarYearsf: (Js.Date.t, Js.Date.t) => float =
  "date-fns/differenceInCalendarYears"
@module external differenceInYears: (Js.Date.t, Js.Date.t) => int = "date-fns/differenceInYears"
@module external differenceInYearsf: (Js.Date.t, Js.Date.t) => float = "date-fns/differenceInYears"
@module external eachWeekendOfYear: Js.Date.t => array<Js.Date.t> = "date-fns/eachWeekendOfYear"
...
@module external addISOWeekYears: (Js.Date.t, int) => Js.Date.t = "date-fns/addISOWeekYears"
@module external addISOWeekYearsf: (Js.Date.t, float) => Js.Date.t = "date-fns/addISOWeekYears"
@module
...
@module external isSameISOWeekYear: (Js.Date.t, Js.Date.t) => bool = "date-fns/isSameISOWeekYear"
@module external lastDayOfISOWeekYear: Js.Date.t => Js.Date.t = "date-fns/lastDayOfISOWeekYear"
@module external setISOWeekYear: (Js.Date.t, int) => Js.Date.t = "date-fns/setISOWeekYear"
@module external setISOWeekYearf: (Js.Date.t, float) => Js.Date.t = "date-fns/setISOWeekYear"
@module external startOfISOWeekYear: Js.Date.t => Js.Date.t = "date-fns/startOfISOWeekYear"
@module external subISOWeekYears: (Js.Date.t, int) => Js.Date.t = "date-fns/subISOWeekYears"
@module external subISOWeekYearsf: (Js.Date.t, float) => Js.Date.t = "date-fns/subISOWeekYears"
...
@module external getWeekYearOpt: (Js.Date.t, weekYearOptions) => int = "date-fns/getWeekYear"
@module external getWeekYearf: Js.Date.t => float = "date-fns/getWeekYear"
@module external getWeekYearOptf: (Js.Date.t, weekYearOptions) => float = "date-fns/getWeekYear"
